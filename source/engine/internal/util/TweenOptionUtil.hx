...
class TweenOptionUtil extends FlxTween{

	/**
	* [Tween Type name]
	* @param type Type name in String
	*/
	public static function getType(?type:String):FlxTweenType{
		var i:FlxTweenType = FlxTweenType.PERSIST;
		switch (type){
			case 'persist': i = FlxTweenType.PERSIST;
			case 'looping': i = FlxTweenType.LOOPING;
			case 'pingpong': i = FlxTweenType.PINGPONG;
			case 'oneshot': i = FlxTweenType.ONESHOT;
			case 'backward': i = FlxTweenType.BACKWARD;
		}
		return i;
	}
