...
class ArrayTools{
  ...
  */
  public static function clear<T>(array:Array<T>):Void{ // This method is faster than array.splice(0, array.length)
  ...
  */
  public static function isSubset<T>(subset:Array<T>, superset:Array<T>):Bool{
    return isSuperset(superset, subset); // Switch it around.
  }
}