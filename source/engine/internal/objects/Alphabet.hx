...
class Alphabet extends FlxSpriteGroup{
	...
	public var changeX = true;
	public var changeY = true;
	...
	public var distancePerItem = new FlxPoint(20, 120);
	public var startPosition = new FlxPoint(0, 0); //for the calculations
	public function new(x:Float, y:Float, text = "", ?bold = true){
		super(x, y);
...
class AlphaCharacter extends FlxSprite{
	...
	public function new(){
		super(x, y);
		image = 'alphabet';
		antialiasing = true; //ClientPrefs.data.antialiasing;
	}
