...
class Paths{
    ...
    public static function sound(key:String, ?library:String):String{
        return getPath('sounds/$key.${Persist.EXT_SOUND}', SOUND, library);
    }
    ...
    public static function music(key:String, ?library:String):String{
        return getPath('music/$key.${Persist.EXT_SOUND}', MUSIC, library);
    }
    ...
    public static function voices(song:String, ?suffix:String = ''):String{
        ...
        return 'songs:assets/songs/${song.toLowerCase()}/Voices$suffix.${Persist.EXT_SOUND}';
    }
